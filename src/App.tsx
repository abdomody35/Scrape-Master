      ...
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1 space-y-12">
        ...
        <div className="space-y-6">
          <div className="flex flex-wrap justify-between gap-3 p-4">
            ...
            <a href="/scrape">
              <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-6 bg-[#293038] text-white text-sm font-medium leading-normal hover:bg-[#3a4451] transition-colors">
